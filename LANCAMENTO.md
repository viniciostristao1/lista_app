...
- **A — `v0.26.0-teste30`** (commit `d35ae12`) → asset `lista-app-v0.26.0.aab` — feature
  ...
  **maiúscula** + **ajuste de fonte** (Menor ~13,5 / Normal ~15 / Maior ~17,7). É o **ALVO de
  ...
  - APK+AAB: https://github.com/viniciostristao1/lista_app/releases/tag/v0.26.0-teste30
  - *(supera `v0.25.0-teste29`.)*
