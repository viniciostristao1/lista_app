...
**Versão atual (A):** `v0.44.0-teste49` — *Save List (nome + logo) + Nota rápida/recados com **To-do por linha** (enter cria item, backspace junta) + abre já no mercado favorito ⭐ + PT/EN/ES + 4 temas.*
